...
function Button(props) {
  return (
    <button className="inline-block py-4 text-xl text-white bg-gray-800 px-7 hover:bg-gray-700 active:bg-gray-600 rounded-xl m-1 focus:ring focus:ring-orange-400 ">
